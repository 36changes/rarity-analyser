...
router.get('/wallet', function(req, res, next) {
  ...
  let punks = null;
  if (isAddress) {
    let url = 'https://api.opensea.io/api/v1/assets?owner='+search+'&asset_contract_address=0xf2febe0fc74ebea939240851686d5b5455d200ab&order_direction=desc&offset=0&limit=50';
